...
public class AcousticCommands
{
    ...
    {
        const object PROC_NAME = "ReleaseAcousticControl";
        bool bRaiseError = false;
        string sRaiseErrorText = "";
        int lRaiseErrorNumber = 0;
        try
    ...
    public void SendAcousticParameters()
    {
        ...
        d248(1);
        a248(1);
        const object PROC_NAME = "SendAcousticParameters";
        d252(1);
        d258(3);
        d263(2);
        a264(2);
        Commands.Clear(PROC_NAME, GetInvalidOpcodes(ocSendPars.ToString()));
        ...
        d378(2);
        a379(4);
        const object PROC_NAME = "SetAcousticTrigger";
        bool bRaiseError = false;
        string sRaiseErrorText = "";
        int lRaiseErrorNumber = 0;
        d381(1);
    ...
    public void StartAcousticLogging(object LogToMsgLog = null)
    {
        ...
        d426(1);
        a426(1);
        const object PROC_NAME = "StartAcousticRecord";
        d466(1);
        d468(2);
        d474(1);
        a474(1);
        ...
        d510(1);
        a510(1);
        const object PROC_NAME = "StopAcousticRecord";
        d521(2);
        a522(2);
        Commands.Clear(PROC_NAME, GetInvalidOpcodes(ocCancelRecord.ToString()));
        ...
        Public(Sub);
        TakeAcousticControl()();
        const object PROC_NAME = "TakeAcousticControl";
        bool bRaiseError = false;
        string sRaiseErrorText = "";
        int lRaiseErrorNumber = 0;
        try
