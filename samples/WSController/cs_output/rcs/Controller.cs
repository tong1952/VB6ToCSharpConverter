...
public class Controller : ICcrpTimerNotify
{
    ...
    private float mipIdleMotorStop;
    private float mipIdleStoppedStatus;
    private float mipIdleStartedStatus;
    private float mipIdleFault;
    private float mipIdleCmdPerm;
    private float mipIdleOpenStatus;
    private float mipIdleClosedStatus;
    private float mipIdleMotionStatus;
    private float mipIdleLight;
    private float mopIdleOpenControl;
    private float mopIdleCloseControl;
    private float[] mccfCloseTimesNormal;
    private float[] mccfCloseTimeSpeedsNormal;
    private float[] mccfCloseTimesSmall;
    private float[] mccfCloseTimeSpeedsSmall;
    private float mopWSToPLC;
    private float mipAuxPerm;
    private float[] mccfMinBlockage = new float[2 + 1];
    private float[] mccfMaxBlockage = new float[2 + 1];
    private float[] mccfCStatic_A0 = new float[2 + 1];
    private float[] mccfCStatic_A1 = new float[2 + 1];
    private float[] mccfCStatic_A2 = new float[2 + 1];
    private float[] mccfCDynamic_A0 = new float[2 + 1];
    private float[] mccfCDynamic_A1 = new float[2 + 1];
    private float[] mccfCDynamic_A2 = new float[2 + 1];
    private float[] mccfCStatic_A0_BL = new float[2 + 1];
    private float[] mccfCStatic_A1_BL = new float[2 + 1];
    private float[] mccfCStatic_A2_BL = new float[2 + 1];
    private float[] mccfCDynamic_A0_BL = new float[2 + 1];
    private float[] mccfCDynamic_A1_BL = new float[2 + 1];
    private float[] mccfCDynamic_A2_BL = new float[2 + 1];
    private int[] mcclNumCloseTimes = new int[2 + 1];
    private float[] mccfCloseWsRamp = new float[2 + 1];
    private float[] mccfCloseWsFilTc = new float[2 + 1];
    private float[] mccfWsFilterTc0 = new float[2 + 1];
    private float[] mccfWsFilterTc1 = new float[2 + 1];
    private float[] mccfWsFilterFast = new float[2 + 1];
    private float[] mccfWsFilterFastTrack = new float[2 + 1];
    private float[] mccfNomFs = new float[2 + 1];
    private float[] mccfMaxFs = new float[2 + 1];
    private float[] mccfKp0 = new float[2 + 1];
    private float[] mccfKp1 = new float[2 + 1];
    private float[] mccfKp0Track = new float[2 + 1];
    private float[] mccfKp1Track = new float[2 + 1];
    private float[] mccfKpMin = new float[2 + 1];
    private float[] mccfKpMax = new float[2 + 1];
    private float[] mccfTi0 = new float[2 + 1];
    private float[] mccfTi1 = new float[2 + 1];
    private float[] mccfTi0Track = new float[2 + 1];
    private float[] mccfTi1Track = new float[2 + 1];
    private float[] mccfTiMin = new float[2 + 1];
    private float[] mccfTiMax = new float[2 + 1];
    private float[] mccfTd0 = new float[2 + 1];
    private float[] mccfTd1 = new float[2 + 1];
    private float[] mccfTd0Track = new float[2 + 1];
    private float[] mccfTd1Track = new float[2 + 1];
    private float[] mccfTdMin = new float[2 + 1];
    private float[] mccfTdMax = new float[2 + 1];
    private float[] mccfNomWs = new float[2 + 1];
    private float[] mccfMaxWs = new float[2 + 1];
    private float[] mccfControlFilTc0 = new float[2 + 1];
    private float[] mccfControlFilTc1 = new float[2 + 1];
    private float[] mccfControlFilTcMin = new float[2 + 1];
    private float[] mccfControlFilTcMax = new float[2 + 1];
    private float mgvfCStatic_A0;
    private float mgvfCStatic_A1;
    private float mgvfCStatic_A2;
    private float mgvfCDynamic_A0;
    private float mgvfCDynamic_A1;
    private float mgvfCDynamic_A2;
    private float mgvfPstaticPa;
    private float mgvfPDiffCorr;
    private float mgvfMach;
    private float mgvfPDiffCorrControl;
    private float mgvfMachControl;
    private float mipReadyToRun;
    private float mipMfReady;
    private float mipMfFault;
    private float mipMfDriveFault;
    private float mipAuxStatus;
    private float mipAuxReady;
    private float mopHxHighDpFault;
    private float mopHxDpOverDpFault;
    private float mopIdleResetControl;
    private float mopMfReverseEnable;
}